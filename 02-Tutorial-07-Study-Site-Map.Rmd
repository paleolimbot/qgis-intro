...
![Slide1](images/Tutorials/07-Study-Site-Map/Slide1.jpg)
...
![Slide2](images/Tutorials/07-Study-Site-Map/Slide2.jpg)
...
![Slide3](images/Tutorials/07-Study-Site-Map/Slide3.jpg)

Select *Open* to add the layers.

![Slide4](images/Tutorials/07-Study-Site-Map/Slide4.jpg)
...
![Slide5](images/Tutorials/07-Study-Site-Map/Slide5.jpg)
...
![Slide6](images/Tutorials/07-Study-Site-Map/Slide6.jpg)

You should also change the style for the NS Counties layer such that it has only borders and no fill.

![Slide7](images/Tutorials/07-Study-Site-Map/Slide7.jpg)
...
![Slide8](images/Tutorials/07-Study-Site-Map/Slide8.jpg)

After setting the CRS, your map should look like this.

![Slide9](images/Tutorials/07-Study-Site-Map/Slide9.jpg)

## The Assignment

For your assignment, create a Print Composer and add a scale bar, north arrow, and legend.

![The Assignment](images/Tutorials/07-Study-Site-Map/08 NS Study Sites.png)
