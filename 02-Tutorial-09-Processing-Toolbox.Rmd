...
![Slide01](images/Tutorials/09-Processing-Toolbox/Slide01.jpg)

Open the *long_lake_depths* and *long_lake_outline* layers from the "10 Interpolation Contouring" folder.

![Slide02](images/Tutorials/09-Processing-Toolbox/Slide02.jpg)
...
![Slide03](images/Tutorials/09-Processing-Toolbox/Slide03.jpg)
...
![Slide04](images/Tutorials/09-Processing-Toolbox/Slide04.jpg)

In the algorithm window, choose the *Input points layer* as "long_lake_depths".

![Slide05](images/Tutorials/09-Processing-Toolbox/Slide05.jpg)

Next, we have to pick the attribute column that contains our "known" depth values. This is "depth_m".

![Slide06](images/Tutorials/09-Processing-Toolbox/Slide06.jpg)
...
![Slide07](images/Tutorials/09-Processing-Toolbox/Slide07.jpg)
...
![Slide08](images/Tutorials/09-Processing-Toolbox/Slide08.jpg)
...
![Slide09](images/Tutorials/09-Processing-Toolbox/Slide09.jpg)
...
![Slide10](images/Tutorials/09-Processing-Toolbox/Slide10.jpg)

The *Input* layer is "Surface", and the *Polygons* layer is "long_lake_outline". Choose *Run* to run the algorithm.

![Slide11](images/Tutorials/09-Processing-Toolbox/Slide11.jpg)
...
![Slide12](images/Tutorials/09-Processing-Toolbox/Slide12.jpg)

The output should be a raster layer that only has values inside the lake boundary. Remove the "Surface" layer.

![Slide13](images/Tutorials/09-Processing-Toolbox/Slide13.jpg)
...
![Slide14](images/Tutorials/09-Processing-Toolbox/Slide14.jpg)

Our *Input raster* is the "Output" layer, the minimum contour level is 0.5, the maximum is 2, and the interval is 0.5 m.

![Slide15](images/Tutorials/09-Processing-Toolbox/Slide15.jpg)
...
![Slide16](images/Tutorials/09-Processing-Toolbox/Slide16.jpg)
...
![Slide17](images/Tutorials/09-Processing-Toolbox/Slide17.jpg)

Choose a location in which to save the raster output.

![Slide18](images/Tutorials/09-Processing-Toolbox/Slide18.jpg)

Save it as something descriptive in the tutorial folder.

![Slide19](images/Tutorials/09-Processing-Toolbox/Slide19.jpg)

Press *OK* to save the raster layer.

![Slide20](images/Tutorials/09-Processing-Toolbox/Slide20.jpg)

Next we will save the "contours" layer. Right click and choose *Save As...*.

![Slide22](images/Tutorials/09-Processing-Toolbox/Slide22.jpg)

I usually save contour layers with the contour interval somewhere in the name of the file.

![Slide23](images/Tutorials/09-Processing-Toolbox/Slide23.jpg)

Remove the temporary layers, and you should have a project that looks like this.

![Slide24](images/Tutorials/09-Processing-Toolbox/Slide24.jpg)
